(function() {
    ...
    angular
        .module('app.bizdesk.calendar')
        .config(moduleConfig);

    /* @ngInject */
    function moduleConfig($translatePartialLoaderProvider, $stateProvider, triMenuProvider) {
        $translatePartialLoaderProvider.addPart('app/bizdesk/calendar');
        ...
        .state('triangular.admin-calendar', {
            ...
            views: {
                ...
                toolbar: {
                    templateUrl: 'app/bizdesk/calendar/toolbar.tmpl.html',
                ...
                belowContent: {
                    templateUrl: 'app/bizdesk/calendar/calendar-fabs.tmpl.html',
        ...
        .state('triangular.admin-calendar.calendar', {
            ...
            templateUrl: 'app/bizdesk/calendar/calendar.tmpl.html',
