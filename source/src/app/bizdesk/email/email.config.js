(function() {
    ...
    function moduleConfig($translatePartialLoaderProvider, $stateProvider, triMenuProvider, EMAIL_ROUTES) {
        $translatePartialLoaderProvider.addPart('app/bizdesk/email');
        ...
        .state('triangular-no-scroll.email', {
            ...
            views: {
                ...
                toolbar: {
                    templateUrl: 'app/bizdesk/email/toolbar.tmpl.html',
        ...
        angular.forEach(EMAIL_ROUTES, function(route) {
            ...
            .state(route.state, {
                url: route.url,
                templateUrl: 'app/bizdesk/email/inbox.tmpl.html',
        ...
        angular.forEach(EMAIL_ROUTES, function(route) {
            ...
            .state(route.state + '.email', {
                url: '/mail/:emailID',
                templateUrl: 'app/bizdesk/email/email.tmpl.html',
